...
<script setup>
import eyePng from '@/assets/img/index/eye.png';
import userPlus from '@/assets/img/index/userPlus.png';
import trendPng from '@/assets/img/index/trend.png';
import statisticPng from '@/assets/img/index/statisticBg.png';
